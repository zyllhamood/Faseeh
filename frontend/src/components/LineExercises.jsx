...
export default function LineExercises({ numLine }) {
    ...
    return (
        <Flex alignItems={'center'} dir='rtl' mt={12} alignSelf={'end'} mr={{ base: 8, md: 10, "2xl": 12, "3xl": 14 }} >
            ...
            <Flex bgColor={numLine > 3 ? bk_done : bk_undone} h={{ base: BoxMobile, md: BoxBrowser, "2xl": Box2xl, "3xl": Box3xl }} w={{ base: BoxMobile, md: BoxBrowser, "2xl": Box2xl, "3xl": Box3xl }} borderRadius={8} justifyContent={'center'} alignItems={'center'}>
